<section class="hero">
        <div class="hero-content">
            ...
            <h2>TOP DIGITAL MARKETING MANAGEMENT AGENCY IN DUBAI UAE FOR GROWTH</h2>
            
            <div class="stats">
                <div class="stat-item">
                    <h3><span id="exp">15</span><span class="symbol">+</span></h3>
                    <p>YEARS OF<br>EXPERIENCE</p>
                </div>
                <div class="stat-item">
                    <h3><span id="experts">22</span><span class="symbol">+</span></h3>
                    <p>TEAM OF<br>EXPERTS</p>
                </div>
                <div class="stat-item">
                    <h3><span id="projects">4200</span><span class="symbol">+</span></h3>
                    <p>SUCCESSFUL<br>PROJECTS</p>
                </div>
                <div class="stat-item">
                    <h3><span id="retention">95</span><span class="symbol">%</span></h3>
            ...
            <div class="partners-row">
                ...
                <div class="partner-card">
                    <div class="badge-circle">
                         ...
                         <svg viewBox="0 0 100 100" style="position:absolute; width:100%; height:100%; transform: rotate(-90deg);">
                            <path id="curve1" d="M 15, 50 a 35,35 0 1,1 70,0 a 35,35 0 1,1 -70,0" fill="transparent"/>
                            <text width="100" font-size="8" fill="#555" letter-spacing="1">
                                <textPath href="#curve1" startOffset="0">GOOGLE ADS AI-POWERED PERFORMANCE</textPath>
                            </text>
                         </svg>
                    </div>
                </div>
                ...
                <div class="partner-card">
                    <div class="badge-circle">
                         ...
                         <svg viewBox="0 0 100 100" style="position:absolute; width:100%; height:100%; transform: rotate(-90deg);">
                            <path id="curve2" d="M 15, 50 a 35,35 0 1,1 70,0 a 35,35 0 1,1 -70,0" fill="transparent"/>
                            <text width="100" font-size="9" fill="#555" letter-spacing="2">
                                <textPath href="#curve2" startOffset="10">SHOPPING ADS CERTIFIED</textPath>
                            </text>
                         </svg>
                    </div>
                </div>
