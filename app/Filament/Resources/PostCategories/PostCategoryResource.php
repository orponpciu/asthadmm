...
use BackedEnum;
use UnitEnum; // Added this import for the strict typing
...
class PostCategoryResource extends Resource
{
    ...
    // FIXED: The exact strict typing required by Filament's base Resource class
    protected static string|UnitEnum|null $navigationGroup = 'Post Settings';

    // Sets the default field used when searching globally for this model
